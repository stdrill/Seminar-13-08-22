...
Для перемещения между ветками в терминале необходимо ввести команду *git checkout <название ветки>*. Для переключения ветка должна существовать и в текущей ветке не должно быть активных изменений.
